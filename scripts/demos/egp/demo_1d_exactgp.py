...
mc_transform = init_mc_moment_transform(
    meanf, n_features=n_features, mc_samples=mc_samples, covariance=covariance
)

key, mc_rng = jax.random.split(key, 2)
mu, var = jax.vmap(mc_transform, in_axes=(None, 0, None), out_axes=(0, 0))(
    mc_rng, Xtest_noisy, input_cov
)
...
mu, var = jax.vmap(unscented_transform, in_axes=(0, None), out_axes=(0, 0))(
